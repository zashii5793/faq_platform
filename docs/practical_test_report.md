# 実用テスト レポート — タカヤモーター株式会社想定

| 項目 | 内容 |
|---|---|
| 検証対象 | Inquira FAQプラットフォーム v0.4 |
| 想定顧客 | タカヤモーター株式会社（自動車整備業・本社+各拠点・35名規模） |
...
| 顧客への提示 | 🟢 **可能** | 営業デモで「使えそう」と思わせられる完成度 |
...
| タカヤCarEditにログインできない | 85% | タカヤCarEdit操作.md ✅ |
...
| 回答率 | 66% |
| 平均確信度 | 53% |
| トップトピック | vpn 5件 / 緊急ロードサービス 2件 / 保証規定 2件 / タカヤCarEdit操作 2件 / 勤怠 2件 |
