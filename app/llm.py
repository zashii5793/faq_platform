...
8. 出力フォーマット（読みやすさ重視）:
   ...
   - **出典は本文と1行空けてから「**出典:** ファイル名」の形で1行に整理**
   - 出典に内部チャンク番号 (#430 等) は**書かない**。ファイル名だけで十分。
     データに Issue 番号やキー (例: NATC-494, JIRA-123) が含まれていれば併記してよい
   - 例: 「**出典:** Backlog-Issues.md (NATC-494, NATC-1916)」
